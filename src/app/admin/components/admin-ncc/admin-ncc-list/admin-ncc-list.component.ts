...
@Component({
  selector: 'app-admin-ncc-list',
  templateUrl: './admin-ncc-list.component.html',
  styleUrls: ['./admin-ncc-list.component.css',
...
export class AdminNccListComponent {
  ...
  delete(item: any) {
    ...
    if (del == true) {
      this.NccServices.delete(item).subscribe((data) => {
